class MovieDetailsResponse {
  ...
  static List<MovieDetailsResponse> fromList(List<Map<String, dynamic>> list) {
    return list.map(MovieDetailsResponse.fromJson).toList();
  }
...
class Movie {
  ...
  static List<Movie> fromList(List<Map<String, dynamic>> list) {
